...
def generate_launch_description() -> LaunchDescription:
    ...
    #     }],
    #     remappings=[
    #         ('input/infra_1', '/camera/infra1/image_rect_raw_dy'), # keti  여기서  ros2 topic echo /camera/realsense_splitter_node/output/depth  문제문제문제
    #         ('input/infra_1_metadata', '/camera/infra1/metadata'),
    #         ('input/infra_2', '/camera/infra2/image_rect_raw_dy'), # keti
    #         ('input/infra_2_metadata', '/camera/infra2/metadata'),
    #         ('input/depth', '/camera/depth/image_rect_raw_dy'),    # keti
