...
def generate_launch_description() -> LaunchDescription:
    ...
    realsense_splitter_node = ComposableNode(
        ...
        remappings=[
            ('input/infra_1', '/camera/infra1/image_rect_raw'), # keti  
            ...
            ('input/depth', '/camera/depth/image_rect_raw'),    # keti : image_rect_raw_dy(원본)을 쓸수밖에 없다 이 depth는 republish가 안 된다.
