...
#include "realsense_splitter/keti_realsense_splitter_node.hpp"
...
KetiRealsenseSplitterNode::KetiRealsenseSplitterNode(const rclcpp::NodeOptions & options)
: Node("keti_realsense_splitter_node", options)
{
  RCLCPP_INFO(get_logger(), "Creating a KetiRealsenseSplitterNode().");
  ...
  timesync_infra_1_->registerCallback(
    std::bind(
      &KetiRealsenseSplitterNode::image1Callback, this,
  ...
  timesync_infra_2_->registerCallback(
    std::bind(
      &KetiRealsenseSplitterNode::image2Callback, this,
      std::placeholders::_1, std::placeholders::_2));
  ...
  timesync_depth_->registerCallback(
    std::bind(
      &KetiRealsenseSplitterNode::depthCallback, this,
      std::placeholders::_1, std::placeholders::_2));
  ...
  timesync_pointcloud_->registerCallback(
    std::bind(
      &KetiRealsenseSplitterNode::pointcloudCallback, this,
      std::placeholders::_1, std::placeholders::_2));
  ...
  depth_pub_ = create_publisher<sensor_msgs::msg::Image>("~/output/depth", output_qos); // keti
  pointcloud_pub_ =
    create_publisher<sensor_msgs::msg::PointCloud2>("~/output/pointcloud", output_qos);
}

int KetiRealsenseSplitterNode::getEmitterModeFromMetadataMsg(
...
void KetiRealsenseSplitterNode::republishIfEmitterMode(
...
void KetiRealsenseSplitterNode::image1Callback(
...
void KetiRealsenseSplitterNode::image2Callback(
  sensor_msgs::msg::Image::ConstSharedPtr image,
  realsense2_camera_msgs::msg::Metadata::ConstSharedPtr metadata)
{
...
void KetiRealsenseSplitterNode::depthCallback(
  sensor_msgs::msg::Image::ConstSharedPtr image,
  realsense2_camera_msgs::msg::Metadata::ConstSharedPtr metadata)
{
...
void KetiRealsenseSplitterNode::pointcloudCallback(
...
RCLCPP_COMPONENTS_REGISTER_NODE(nvblox::KetiRealsenseSplitterNode)
